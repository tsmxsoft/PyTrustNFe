...
class Assinatura(object):
    ...
    def assina_xml_consulta(self, xml_element):
        cert, key = self.extract_cert_key()
        ...
        prestador = xml_element.find(".//Prestador")
        if prestador is not None and signature is not None:
            prestador.addnext(signature)
