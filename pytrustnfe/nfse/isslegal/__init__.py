...
def _send(certificado, method, **kwargs):
    if kwargs.get("ambiente") == "homologacao":
        base_url = "http://200.251.30.48:8080/serversoap/NfseWSService?wsdl"
    else:
        base_url = "https://api.redemunicipal.com.br/serversoap/NfseWSService?wsdl"
    ...
    headers = {
        ...
        "Authorization": "Bearer %s" % kwargs["nfse"]["chave_digital"],
