...
def _send(certificado, method, **kwargs):
    ...
    if kwargs["ambiente"] == "homologacao":
        url = "https://serem-hml.joaopessoa.pb.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap?wsdl"
    elif kwargs["ambiente"] == "producao":
        url = "https://receita.joaopessoa.pb.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap?wsdl"
    else:
