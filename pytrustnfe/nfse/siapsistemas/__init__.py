...
def _send(certificado, method, **kwargs):
    ...
    endpoint = {
        "RecepcionarLoteRpsSincrono":"arecepcionarloterpssincrono",
        "ConsultarLoteRps":"aconsultarloterps",
    }

    if kwargs.get("ambiente") == "homologacao":
        base_url = base_url + "/rpshomologa/servlet/" + endpoint[method] + "?wsdl"
    else:
        base_url = base_url + "/rps/servlet/" + endpoint[method] + "?wsdl"
    ...
    action = "SantaremRPSaction/%s.Execute" %(endpoint[method].upper())
    headers = {
